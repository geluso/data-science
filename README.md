##![](https://ga-dash.s3.amazonaws.com/production/assets/logo-9f88ae6c9c3871690e33280fcf557f33.png)  SEA-DS3 course repository
...
6/27: [L01 Introduction to Data Science](#class-1) | 6/29: [L02 Research design and Pandas](#research-design)
7/4: Holiday - No class | 7/6: [L03 Statistics fundamentals](#stat_fund)
7/11: [L04 Command Line and Version Control](#command-line) | 7/13: [L05 Fetching Data](#fetching-data), **Project Discussion Deadline** |
**Foundations of data modeling**|
7/18: [L06 Intro to Regression](#intro-to-regression), **Project Question and Dataset Due** | 7/20: [L07 Intro to Classification - K nearest neighbor](#knn)
7/25: [L08 Evaluating Model Fit](#evaluating-fit) | 7/27: [L09 Classifying with Logistic Regression](#logistic-regression)
8/1: [L10 Advanced model evaluation](#advanced-model) | 8/3: [L11 Standardization and Clustering](#clustering)
8/8: L12: **First Project Presentations** + bonus topics | 
**Data science in the real world**|
 | 8:10 [L13 Natural Language Processing](#nlp1)
8/15: [L14 Dimensionality reduction](#reduction), **Draft Paper Due** | 8/17: [L15 Decision Trees](#decision)
8/22: [L16 Ensembling, Bagging and Random Forests](#ensemble) | 8/24: [L17 Modeling with Time Series Data I](#time1), **Peer Review Due**
8/29 [L18 Modeling with Time Series Data II](#time2) | 5/17: [L19 Where to go next + bonus topics](#19_topics)
9/5 **Holiday - No class** | 5/19: **Final Project Presentations**
 | 
 | 
 | 
**Bonus Content** | 
...
-->
####   [Homework and project submissions form] (https://docs.google.com/forms/d/e/1FAIpQLScH_m8Le4w0sqsvm5uNOTd08p4KDTW8WgnWVP1kFf4CCBi2Ow/viewform)
<!--
...
**Homework:**
* Complete this [homework assignment](homework/06_yelp_votes_homework.ipynb) with the [Yelp data](data/yelp.csv). This is due on Monday July 25th.
